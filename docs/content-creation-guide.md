...
## 💬 社区资源
- [GitHub Issues](https://github.com/mauyin/haskell-101-cn/issues)
...
**这很正常！** [具体概念] 的思维方式可能完全不同。建议：

1. **多看几遍讲义** - 第一遍不理解很正常
2. **在 GHCi 中多实验** - 改变代码，观察结果
3. **不要纠结细节** - 有些概念会在后面逐渐清晰
4. **给自己时间** - [该周概念] 需要时间适应

### 准备好了吗？

如果你完成了至少 **80%** 的练习，就可以进入下一周了！

即使有些练习没有完全理解也没关系，下一周会继续强化这些概念。
```
...
> 💡 **自学提示**: 
> 这一周可能需要 X-Y 小时完成。
> 如果遇到 [常见问题]，不要气馁！这是学习 [该周概念] 时的常见现象。
> 慢慢来，每一步都检查清楚。
```

在 lecture.md 适当位置添加"常见困惑"：
