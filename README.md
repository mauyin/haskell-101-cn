...
<tbody>
<tr>
<td style="text-align: center; white-space: nowrap;"><a href="./src/week-00-setup/README.md">Week 0</a></td>
<td>环境搭建</td>
<td>GHCup、VS Code + Haskell 扩展、GHCi 入门</td>
<td>安装验证 + "Hello, Cardano!"</td>
</tr>
<tr>
<td style="text-align: center; white-space: nowrap;"><a href="./src/week-01-basics/README.md">Week 1</a></td>
<td>Haskell 基础语法</td>
<td>函数、类型、列表、递归、高阶函数、lambda</td>
<td>列表处理（map/filter/foldr）</td>
</tr>
<tr>
<td style="text-align: center; white-space: nowrap;"><a href="./src/week-02-datatypes/README.md">Week 2</a></td>
<td>数据类型与模式匹配</td>
<td>元组、ADT、记录、case 表达式</td>
<td>自定义 Tree、Result 类型练习</td>
</tr>
<tr>
<td style="text-align: center; white-space: nowrap;"><a href="./src/week-03-typeclasses/README.md">Week 3</a></td>
<td>类型类</td>
<td>Eq/Ord/Show/Functor/Applicative/Monad、deriving</td>
<td>实现自定义实例 + foldable 实例</td>
</tr>
<tr>
<td style="text-align: center; white-space: nowrap;"><a href="./src/week-04-monad-io/README.md">Week 4</a></td>
<td>Monad 与 IO</td>
<td>do 记法、纯函数与副作用、文件/网络 IO</td>
<td>猜数字游戏 + 简单命令行 TODO</td>
</tr>
<tr>
<td style="text-align: center; white-space: nowrap;"><a href="./src/week-05-modules/README.md">Week 5</a></td>
<td>模块与项目管理</td>
<td>Cabal 项目、常用库（aeson、bytestring、req）</td>
<td>天气查询工具 + JSON 解析程序</td>
</tr>
<tr>
<td style="text-align: center; white-space: nowrap;"><a href="./src/week-06-testing/README.md">Week 6</a></td>
<td>错误处理与测试</td>
<td>Maybe/Either/ExceptT、QuickCheck</td>
<td>带错误处理程序 + 属性测试</td>
</tr>
<tr>
<td style="text-align: center; white-space: nowrap;"><a href="./src/week-07-cardano/README.md">Week 7</a></td>
...
<tr>
<td style="text-align: center; white-space: nowrap;"><a href="./src/week-08-project/README.md">Week 8</a></td>
<td>结课项目</td>
...
在线版本部署中... (Last updated: 2025-11-19)
